...
class PaymentService {
  constructor() {
    this.tokensMercadoPago = {
      ...
      test: {
        access_token:
          "APP_USR-1794701890025266-120704-c84a46e519f9c76bf9d25c0cac484a84-683788831" 
...
//(al igual que hicimos con el precio del item) 
        name: "Lalo",
        surname: "Landa",
        email: "test_user_9610474@testuser.com",
...
// declaramos las urls de redireccionamiento
        success: "https://supportbike.herokuapp.com/success", 
// url que va a redireccionar si sale todo bien
        pending: "https://supportbike.herokuapp.com/pending", 
// url a la que va a redireccionar si decide pagar en efectivo por ejemplo
        failure: "https://supportbike.herokuapp.com/failure" 
// url a la que va a redireccionar si falla el pago
      }, 
      notification_url: "https://supportbike.herokuapp.com/webhook", 
